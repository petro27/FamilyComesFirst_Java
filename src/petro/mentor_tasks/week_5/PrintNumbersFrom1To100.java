...
public class PrintNumbersFrom1To100 {
    /*
    program that can print the numbers between 1 ~ 100 that can be divisible by 3, 5, and 15.
    ...
    public static void main(String[] args) {
        ...
        if (num > 0 && num <= 100) {
                if (num % 15 == 0) {
                    ...
                    System.out.println("Divisible By 3 3 6 9 12 18 21 24 27 33 36 39 42 48 51 54 57 63 66 69 72 78 81 84 87 93 96 99");
                }
        }
    }
}